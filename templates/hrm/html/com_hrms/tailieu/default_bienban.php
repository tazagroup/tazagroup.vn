      ...
      <table class="table table-centered table-nowrap mb-0 rounded text-center table-bordered">
          ...
          <tr>
            <th scope="col"> <div class="dropdown  position-static">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                  ...
                  <li class="p-2 small">
                    <div class="form-check form-switch"> Tên Nhân Viên
                      <input class="form-check-input" type="checkbox" ng-model="tieude.ten" checked>
                    </div>
                  </li>
                  <li class="p-2 small">
                    <div class="form-check form-switch"> Loại Biên Bản
                      <input class="form-check-input" type="checkbox" ng-model="tieude.loaibienban" checked>
                    </div>
                  </li>
                  <li class="p-2 small">
                    <div class="form-check form-switch"> Ngày Cập Nhật
            ...
            <th scope="col" ng-show="tieude.ten==true"> <div class="dropdown position-static">
                <div class="dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                  <div class="d-flex justify-content-center"> Tên Nhân Viên <i class="fas fa-ellipsis-v ms-auto"></i></div>
                </div>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                  <li class="p-2">
                    <input class="form-control" placeholder="Tìm Kiếm" />
            ...
            <th scope="col" ng-show="tieude.loaibienban==true"> <div class="dropdown position-static">
                <div class="dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                  <div class="d-flex"> Loại Biên Bản <i class="fas fa-ellipsis-v ms-auto"></i></div>
                </div>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                  <li class="p-2">
                    <input class="form-control" placeholder="Tìm Kiếm" />
            ...
            <th scope="col" ng-show="tieude.ngay==true"> <div class="dropdown position-static">
                <div class="dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                  <div class="d-flex"> Ngày Cập Nhật <i class="fas fa-ellipsis-v ms-auto"></i></div>
                </div>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                  <li class="p-2">
                    <input class="form-control" placeholder="Tìm Kiếm" />
        ...
        <tbody>
          <tr ng-repeat="t in test">
            ...
            <td ng-show="tieude.ten==true">{{t.Ten}}</td>
            <td ng-show="tieude.loaibienban==true">{{t.Loaibienban}}</td>
          ...
          <tr ng-repeat="i in inputs">
            ...
            <td ng-show="tieude.ten==true"><input ng-model="input.Ten" class="form-control" placeholder="Tên Nhân Viên"/></td>
            <td ng-show="tieude.loaibienban==true"><input ng-model="input.File" class="form-control" placeholder="Loại Biên Bản"/></td>
            <td ng-show="tieude.ngay==true"><input ng-model="input.Ngay" type="date" class="form-control" placeholder="Ngày Ban Hành"/></td>
            <td ng-show="tieude.file==true"><input ng-model="input.Tinhtrang" class="form-control" placeholder="File"/></td>
