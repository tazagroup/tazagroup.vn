        ...
        <table class="table table-centered table-nowrap mb-0 rounded text-center table-bordered">
          ...
          <tbody>
            ...
            <tr ng-repeat="i in inputs">
              ...
              <td ng-show="tieude.file==true">
                  <input ng-model="i.Tenfile" type="file" class="form-control" placeholder="File"/>
                </td>
              <td ng-show="tieude.ngay==true"><input ng-model="i.Ngaybanhanh" type="datetime-local" class="form-control" placeholder="Ngày Ban Hành" format-value="yyyy-MM-ddTHH:mm"/>
                </td>
              <td ng-show="tieude.tinhtrang==true">
                  <select chosen class="w-100" ng-model="i.Tinhtrang" ng-options="s3.id as s3.Thuoctinh for s3 in TTLotrinh">
                  <option value="" selected>Vui lòng chọn</option>
                </select>
                </td>
              <td ng-show="tieude.ghichu==true">
                  <input ng-model="i.Ghichu" class="form-control" placeholder="Ghi Chú"/>
