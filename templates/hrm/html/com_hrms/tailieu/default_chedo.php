        ...
        <table class="table table-centered table-nowrap mb-0 rounded text-center table-bordered">
            ...
            <tr>
              <th scope="col"> <div class="dropdown position-static">
                  ...
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    ...
                    <li class="p-2 small">
                      <div class="form-check form-switch">Loại Tài Liệu
                        <input class="form-check-input" type="checkbox"  ng-model="tieude.loaitailieu" checked>
                      </div>
                    </li>
                    <li class="p-2 small">
              ...
              <th scope="col" ng-show="tieude.loaitailieu==true"> <div class="dropdown position-static">
                  <div class="dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                    <div class="d-flex justify-content-center"> Loại Tài Liệu <i class="fas fa-ellipsis-v ms-auto"></i></div>
                  </div>
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                    <li class="p-2">
                      <input class="form-control" placeholder="Tìm Kiếm" />
          ...
          <tbody>
            <tr ng-repeat="t in RLotrinhs">
              ...
              <td ng-show="tieude.khoi==true">{{t.idKhoi}}</td>
              <td ng-show="tieude.phong==true">{{t.idPhong}}</td>
              <td ng-show="tieude.bophan==true">{{t.idBophan}}</td>
              <td ng-show="tieude.vitri==true">{{t.idVitri}}</td>
              <td ng-show="tieude.loaitailieu==true">{{t.Loaitailieu}}</td>
              <td ng-show="tieude.ngay==true">{{t.Ngaybanhanh}}</td>
            ...
            <tr ng-repeat="i in inputs">
              ...
              <td ng-show="tieude.khoi==true"><div class="btn-group">
                  <input ng-model="i.idKhoi" class="form-control" placeholder="Khối" data-bs-toggle="dropdown" data-bs-auto-close="outside"/>
              ...
              <td ng-show="tieude.phong==true"><input ng-model="i.idPhong" class="form-control" placeholder="Phòng"/></td>
              <td ng-show="tieude.bophan==true"><input ng-model="i.idBophan" class="form-control" placeholder="Bộ Phận"/></td>
              <td ng-show="tieude.vitri==true"><input ng-model="i.idVitri" class="form-control" placeholder="Vị Trí"/></td>
              <td ng-show="tieude.loaitailieu==true"><input ng-model="i.Loaitailieu" class="form-control" placeholder="Loại Tài Liệu"/></td>
              <td ng-show="tieude.ngay==true"><input ng-model="i.Ngaybanhanh" type="date" class="form-control" placeholder="Ngày Ban Hành"/></td>
              <td ng-show="tieude.tinhtrang==true"><input ng-model="i.Tinhtrang" class="form-control" placeholder="Tình Trạng"/></td>
              <td ng-show="tieude.file==true"><input ng-model="i.Tenfile" class="form-control" placeholder="File"/></td>
              <td ng-show="tieude.ghichu==true"><input ng-model="i.Ghichu" class="form-control" placeholder="Ghi Chú"/></td>
            </tr>
            <tr>
              <td colspan="12" class="px-3"><div class="d-flex">
                  <div class="me-auto" ng-click="addinput()" ><span class="btn btn-primary"><i class="fas fa-plus-circle"></i> Thêm Mới</span></div>
                  <div class="ms-auto" ng-show="inputs.length!=0"> <span class="btn btn-danger" ng-click="resetinput()"><i class="fas fa-sync-alt" ></i> Reset</span> <span class="btn btn-info" ng-click="CreateLotrinh(inputs)"><i class="fas fa-save"></i> Lưu</span> </div>
                </div></td>
            </tr>
          </tbody>
        </table>
