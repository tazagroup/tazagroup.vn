...
<li class="nav-item"><a href="/hrm" class="nav-link d-flex align-items-center"><span class="sidebar-icon"><img src="https://tazagroup.vn/templates/tazagroup/images/logo-white.png" height="20" width="20" alt="Taza Group"> </span><span class="mt-1 sidebar-text">Taza Group</span></a></li>    
...
<?php foreach ($list as $i => &$item)
{
	...
	switch (true) :
		...
		case $showAll && $item->deeper:
			echo '<div class="multi-level collapse show" id="submenu-'.$item->id.'">
