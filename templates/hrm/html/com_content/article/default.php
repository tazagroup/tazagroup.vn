...
?>
<div class="col-12 d-flex align-items-center justify-content-center"><div class="com-content-article item-page<?php echo $this->pageclass_sfx; ?> bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100" itemscope itemtype="https://schema.org/Article">
