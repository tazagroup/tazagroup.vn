...
?>
<div class="com-users-profile__edit profile-edit col-12 d-flex align-items-center justify-content-center">
	...
	<form id="member-profile" action="<?php echo Route::_('index.php?option=com_users'); ?>" method="post" class="com-users-profile__edit-form form-validate form-horizontal well bg-white shadow border-0 rounded p-4 p-lg-5 w-100 fmxw-999" enctype="multipart/form-data">
