...
-->
                  <div class="row p-3">                      
<div ng-repeat="dulieu in ListPhanquyen1" class="p-3 mb-2 row border">  
<div class="col-12 my-2">           Nhóm {{dulieu.Nhom}} - {{dulieu.dulieu[0].Thuoctinh}}</div>
    <div class="mb-3 col-4" ng-repeat="pq in dulieu.dulieu">
                      <div class="form-check form-switch d-flex">
                                  <input class="form-check-input me-2" type="checkbox" ng-model="Phanquyen['pq'+pq.id]">
                <label class="form-check-label">{{$index+1}}.{{pq.Thuoctinh}}({{pq.id}})</label>   
                                </div>               
                            </div>
                      </div>
