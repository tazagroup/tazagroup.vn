   ...
   <th ng-show="tieude.td6" style="width: 10%;"> <div class="dropdown position-static">
                        ...
                        <tbody>
                          <tr ng-repeat="rd in RAQuytrinh">
                            ...
                            <td ng-show="tieude.td1" style="width: 10%;">{{rd.idVitri|FCustom:'Thuoctinh':Vitri}}</span></td>       
  ...
  <div class="modal-dialog modal-xl modal-dialog-scrollable">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Nội Dung {{ViewNoidung}}</h5>
      ...
      <div class="modal-body">
        ...
        <div class="mb-3 col-6">
            <div class="input-group"> <span class="input-group-text">Vị Trí</span>
                <select chosen class="form-control text-danger" ng-model="Quytrinh.idVitri" ng-options="s.id as s.Thuoctinh for s in Vitri">
