          ...
          <thead class="thead-light">
            <tr>
              <th style="width: 10%;"> <div class="d-flex justify-content-center">
                  ...
                  <div>
                    <h6><i class="fas fa-plus-circle" ng-click="addLophoc()" data-bs-toggle="modal" data-bs-target="#CRUDLophoc"></i></h6>
                  </div>
                </div>
              </th>
<!--
...
-->
              ...
              <th ng-show="tieude.td4" style="width: 10%;"> <div class="dropdown position-static">
                  ...
                  <ul class="dropdown-menu">
                    <li class="p-2">
                      <div class="input-group mb-2"> <span class="input-group-text"> <i class="fas fa-search"></i> </span>
                        <select multiple chosen class="form-control text-danger" ng-model="Giangvien" ng-options="s.idGV.id as s.idGV.id for s in RALophoc">
                          <option value="" selected>Vui lòng chọn</option>
                        </select>
          ...
          <tbody>
            <tr ng-repeat="rd in RALophoc |FMT:Trangthai:'Trangthai'|FMT:Giangvien:'Giangvien'|FMT:Nguoiduyet:'idDuyet' | filter:timkiem| orderBy:propertyName:reverse">
              <td style="width: 10%;"><div class="dropdown position-static my-auto">
                  ...
                  <ul class="dropdown-menu">
                    <li class="p-2" ng-click="editLophoc(rd)" data-bs-toggle="modal" data-bs-target="#CRUDLophoc"><i class="fas fa-edit text-info"></i> Sửa</li>
                    <li class="p-2" data-bs-toggle="modal" data-bs-target="#XoaHang" ng-click="removeLophoc(rd)" ng-if="Quyen.pq14"><i class="fas fa-trash-alt text-danger"></i> Xóa</li>
                  </ul>
                </div></td>
<!--              <td ng-show="tieude.td1" style="width: 10%;">{{rd.idRoot|FTenchude:RChude}}</td>-->
              ...
              <td ng-show="tieude.td1" style="width: 10%;">{{rd.idBH|FCustom:'Tenbaihoc':Baihocgoc}}</td>
              <td ng-show="tieude.td2" style="width: 10%;">{{rd.Tenlop}}</td>
