<div class="chude" ng-init="ReadChude()"> 
    ...
    <div class="card-header p-2 d-flex">
        ...
        <span class="me-2 my-auto badge rounded-pill bg-info">{{RTailieu.length}}</span>
        <span class="ms-2"> Danh Sách Chủ Đề</span> 
        <i class="fas fa-sync-alt mx-3 my-auto" ng-click="ResetTailieu()"></i>
    ...
    <div class="accordion" id="accordionparent-{{category.level}}" ng-if="category.children">
        <div ng-repeat="category in category.children" class="level-{{category.level}} accordion-item row">
            <h2 class="accordion-header col" ng-click="t['CD'+category.id]=!t['CD'+category.id];LocTLN(category,t)">
...
<ul class="dropdown-menu">
            ...
            <div id="a{{category.id}}" class="accordion-collapse collapse" data-bs-parent="#accordionparent-{{category.level-1}}" ng-class="{'show': localStorage.CDActive['CD'+category.id]}">
