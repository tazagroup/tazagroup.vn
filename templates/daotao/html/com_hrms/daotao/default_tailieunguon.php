        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <div class="input-group"> <span class="input-group-text"> Tags </span>
                    <select chosen multiple class="form-control text-danger" ng-model="Tailieu.Tags" ng-options="s.id as s.Thuoctinh for s in ListTags">
            ...
            <div class="mb-3">
              <form>     
                <div class="d-flex"> 
<div ng-repeat="lk in Tailieu.Lienket" class="d-flex flex-column">   
<div class="d-flex m-auto"><i class="fas fa-file-pdf fs-1"></i>
    <i class="fas fa-minus-circle ms-2 my-auto text-danger" ng-click="RemoveUpload(Tailieu,lk,$index)"></i>
    </div>   
                    <span class="p-3">  <small>{{lk.name}}</small> </span> 
                   </div>
                  </div>
    ...
    <div class="modal fade" id="PDFView" data-bs-backdrop="static" data-bs-keyboard="false">
      <div class="modal-dialog modal-{{FScreen}}">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">{{FilePDF.Title}}</h5> <span class="text-primary ms-3 px-3" ng-click="ChangeFull()"><i class="fas fa-expand-arrows-alt"></i></span>
              ...
              <div class="d-flex">
                <div class="table mt-3 ghichu">
                  <table class="table dauviec table-centered table-nowrap mb-0 rounded text-center table-bordered table-hover">
                            ...
                            <li class="p-2">
                              <div class="mb-3">
                                <div class="input-group mb-2"> <span class="input-group-text"> <i class="fas fa-search"></i> </span>
                                  ...
                                  <span class="input-group-text" ng-click="OninitTailieu()"> <i class="fas fa-sync-alt"></i> </span> <span ng-if="sortflag" class="input-group-text" ng-click="sortBy('Tentailieu')"> <i class="fas fa-sort-up"></i> </span> <span ng-if="!sortflag" class="input-group-text" ng-click="sortBy('Tentailieu')"> <i class="fas fa-sort-down"></i> </span><span class="input-group-text" ng-click="LocPDF(RATailieu)"> <i class="fas fa-file-pdf text-danger"></i> </span> </div>
                              </div>
                            </div>
                            </li>
                          </ul>
                    ...
                    <tbody>
                      <tr ng-repeat="tl in Daduyet = (RATailieu | filter:{Trangthai:'2'}) | orderBy:propertyName:reverse | filter:timkiem |limitTo:limit:from | dateNgaytao:Ngaytao.from:Ngaytao.to" class="TL{{tl.id}}" ng-class="isedit==tl.id?'bg-primary text-white':''">
                        <td style="width: 5%;">
 ...
 <div class="btn-group position-static" ng-if="tl.Lienket.length!=0">
         <span data-bs-toggle="dropdown" data-bs-auto-close="outside"><i class="fas fa-file-pdf text-danger"></i>
            <span ng-if="tl.Lienket.length>2" class="text-danger"> + {{tl.Lienket.length-1}}</span></span>
         <ul class="dropdown-menu">
          <li>
<div ng-repeat="x in tl.Lienket" class="d-flex">              
    <span class="dropdown-item text-info" data-bs-toggle="modal" data-bs-target="#PDFView" ng-click="SetPDF(x)">{{x.name}}
              </span>
                <i class="fas fa-minus-circle me-2 my-auto text-danger" ng-click="RemoveUpload(tl,x,$index)"></i></div>
