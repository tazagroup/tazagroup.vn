 ...
 * @since  1.6
 */
class LotrinhsModel extends ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				...
				[
					$db->quoteName('a.id'),
					$db->quoteName('a.idKhoi'),
					$db->quoteName('a.idPhong'),
					$db->quoteName('a.idBophan'),
					$db->quoteName('a.idVitri'),
					$db->quoteName('a.Ngaybanhanh'),
					$db->quoteName('a.Tinhtrang'),
					$db->quoteName('a.Tenfile'),
					$db->quoteName('a.Url'),
		...
		)->from($db->quoteName('#__hrms_lotrinh', 'a'));
