 ...
 * @since  1.6
 */
class TinnhansModel extends ListModel
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		)->select([$db->quoteName('u.name', 'Nguoigui'),$db->quoteName('u1.name', 'Nguoinhan')])
		->from($db->quoteName('#__hrms_tinnhan', 'a'))
        ->join('LEFT', $db->quoteName('#__users', 'u'), $db->quoteName('u.id') . ' = ' . $db->quoteName('a.idGui'))
