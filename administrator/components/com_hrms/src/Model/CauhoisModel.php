 ...
 * @since  1.6
 */
class CauhoisModel extends ListModel
{
	/**
	 * Constructor.
	 *
	 ...
	 * @since   1.6
	 */
	protected function populateState($ordering = 'a.Cauhoi', $direction = 'asc')
	{
	...
	protected function getListQuery()
	{
		...
		$query->select(
			...
			->from($db->quoteName('#__hrms_cauhoi', 'a'));
		...
		$orderCol  = $this->state->get('list.ordering', 'a.Cauhoi');
