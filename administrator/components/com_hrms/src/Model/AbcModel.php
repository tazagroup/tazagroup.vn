...
class AbcModel extends AdminModel
{
	use VersionableModelTrait;
	public $typeAlias = 'com_hrms.abc';
	...
	{
		// Get the form.
		$form = $this->loadForm('com_hrms.abcs', 'abcs', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_hrms.edit.abcs.data', array());
		...
		$this->preprocessData('com_hrms.abcs', $data);
  	...
  	public function delete(&$pks)
	{
		...
		if ($return)
		{
			...
			$query = $db->getQuery(true)
				->delete($db->quoteName('#__hrms_abc'))
