...
class TodoModel extends AdminModel
{
	use VersionableModelTrait;
	public $typeAlias = 'com_hrms.todo';
	...
	{
		// Get the form.
		$form = $this->loadForm('com_hrms.todos', 'todos', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_hrms.edit.todos.data', array());
		...
		$this->preprocessData('com_hrms.todos', $data);
  	...
  	public function delete(&$pks)
	{
		...
		if ($return)
		{
			...
			$query = $db->getQuery(true)
				->delete($db->quoteName('#__hrms_todo'))
