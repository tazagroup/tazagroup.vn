...
class QuytrinhdaotaoModel extends AdminModel
{
	use VersionableModelTrait;
	public $typeAlias = 'com_hrms.quytrinhdaotao';
	...
	{
		// Get the form.
		$form = $this->loadForm('com_hrms.quytrinhdaotaos', 'quytrinhdaotaos', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$data = Factory::getApplication()->getUserState('com_hrms.edit.quytrinhdaotaos.data', array());
		...
		$this->preprocessData('com_hrms.quytrinhdaotaos', $data);
  	...
  	public function delete(&$pks)
	{
		...
		if ($return)
		{
			...
			$query = $db->getQuery(true)
				->delete($db->quoteName('#__hrms_quytrinhdaotao'))
		...
		if (empty($table->id))
		{
			...
			if (empty($table->ordering))
			{
				...
				$query = $db->getQuery(true)
					...
					->from($db->quoteName('#__hrms_quytrinhdaotao'));
				$db->setQuery($query);
				$max = $db->loadResult();
