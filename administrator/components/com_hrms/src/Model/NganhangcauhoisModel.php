...
class NganhangcauhoisModel extends ListModel
{
	...
	protected function getListQuery()
	{
		...
		$query->select(
			$this->getState(
				...
				[
					...
					$db->quoteName('a.MaCH'),
					$db->quoteName('a.Cauhoi'),
					$db->quoteName('a.Traloi'),
					$db->quoteName('a.Dapan'),
					$db->quoteName('a.Trangthai'),
					$db->quoteName('a.Capdo'),
        ...
        ->from($db->quoteName('#__hrms_nganhangcauhoi', 'a'));
    ...
    public function getItems()
	{
		...
		{
			$item->typeAlias = 'com_hrms.nganhangcauhoi';
