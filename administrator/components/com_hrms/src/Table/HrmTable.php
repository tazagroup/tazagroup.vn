 ...
 * @since  1.6
 */
class HrmTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.hrm';
		parent::__construct('#__hrms', 'id', $db);
	...
	public function store($updateNulls = true)
	{
		...
		$table = Table::getInstance('HrmTable', __NAMESPACE__ . '\\', array('dbo' => $this->_db));
