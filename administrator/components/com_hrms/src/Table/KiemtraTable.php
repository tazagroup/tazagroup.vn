...
class KiemtraTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.kiemtras';
		parent::__construct('#__hrms_kiemtra', 'id', $db);
	}
