...
class AbcTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.abcs';
		parent::__construct('#__hrms_abc', 'id', $db);
	}
