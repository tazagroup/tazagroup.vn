...
class QuytrinhdaotaoTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.quytrinhdaotaos';
		parent::__construct('#__hrms_quytrinhdaotao', 'id', $db);
	}
