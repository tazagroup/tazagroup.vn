 ...
 * @since  1.6
 */
class CaidatTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.caidats';
		parent::__construct('#__hrms_caidat', 'id', $db);
	}
