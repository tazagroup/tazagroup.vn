...
class BaihocTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.baihocs';
		parent::__construct('#__hrms_baihoc', 'id', $db);
	}
