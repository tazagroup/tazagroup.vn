 ...
 * @since  1.6
 */
class LotrinhTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.lotrinhs';
		parent::__construct('#__hrms_lotrinh', 'id', $db);
	}
