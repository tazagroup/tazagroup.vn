...
class ThongbaoTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.thongbaos';
		parent::__construct('#__hrms_thongbao', 'id', $db);
	}
