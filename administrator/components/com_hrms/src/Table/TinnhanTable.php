 ...
 * @since  1.6
 */
class TinnhanTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.tinnhans';
		parent::__construct('#__hrms_tinnhan', 'id', $db);
	}
...
//		$table = Table::getInstance('tinnhanTable', __NAMESPACE__ . '\\', array('dbo' => $this->_db));
//
