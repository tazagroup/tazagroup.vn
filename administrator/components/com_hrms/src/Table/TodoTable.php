...
class TodoTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.todos';
		parent::__construct('#__hrms_todo', 'id', $db);
	}
