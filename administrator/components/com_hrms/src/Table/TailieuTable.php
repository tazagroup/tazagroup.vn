 ...
 * @since  1.6
 */
class TailieuTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.tailieus';
		parent::__construct('#__hrms_tailieu', 'id', $db);
	}
