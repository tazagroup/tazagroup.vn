 ...
 * @since  1.6
 */
class ThumucTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.thumucs';
		parent::__construct('#__hrms_thumuc', 'id', $db);
	}
