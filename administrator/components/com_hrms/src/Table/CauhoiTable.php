 ...
 * @since  1.6
 */
class CauhoiTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.cauhois';
		parent::__construct('#__hrms_cauhoi', 'id', $db);
	}
...
//		$table = Table::getInstance('CauhoiTable', __NAMESPACE__ . '\\', array('dbo' => $this->_db));
//
