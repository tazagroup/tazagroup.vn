...
class NganhangcauhoiTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.nganhangcauhois';
		parent::__construct('#__hrms_nganhangcauhoi', 'id', $db);
	}
