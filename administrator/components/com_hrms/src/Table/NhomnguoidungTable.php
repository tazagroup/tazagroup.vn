...
class NhomnguoidungTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_hrms.nhomnguoidungs';
		parent::__construct('#__hrms_nhomnguoidung', 'id', $db);
	}
