 ...
 * @since  1.6
 */
class CrmController extends FormController
{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Crm', '', array());

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_crms&view=crms' . $this->getRedirectToListAppend(), false));
