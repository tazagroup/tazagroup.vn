...
/**
 * Cauhoi controller class.
 *
 * @since  1.6
 */
class CauhoiController extends FormController
{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Cauhoi', '', array());

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_crms&view=cauhois' . $this->getRedirectToListAppend(), false));
