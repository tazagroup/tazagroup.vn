 ...
 * @since  1.6
 */
class NhapkhoTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_crms.nhapkhos';
		parent::__construct('#__crms_nhapkho', 'id', $db);
	}
...
//		$table = Table::getInstance('NhapkhoTable', __NAMESPACE__ . '\\', array('dbo' => $this->_db));
//
