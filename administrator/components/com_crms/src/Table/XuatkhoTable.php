 ...
 * @since  1.6
 */
class XuatkhoTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_crms.xuatkhos';
		parent::__construct('#__crms_xuatkho', 'id', $db);
	}
...
//		$table = Table::getInstance('XuatkhoTable', __NAMESPACE__ . '\\', array('dbo' => $this->_db));
//
