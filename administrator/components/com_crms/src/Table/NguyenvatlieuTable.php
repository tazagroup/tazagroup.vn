...
/**
 * Nguyenvatlieu Table class.
 *
 * @since  1.6
 */
class NguyenvatlieuTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_crms.nguyenvatlieus';
		parent::__construct('#__crms_nguyenvatlieu', 'id', $db);
	}
...
//		$table = Table::getInstance('NguyenvatlieuTable', __NAMESPACE__ . '\\', array('dbo' => $this->_db));
//
