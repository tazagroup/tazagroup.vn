 ...
 * @since  1.6
 */
class TonkhoTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_crms.tonkhos';
		parent::__construct('#__crms_tonkho', 'id', $db);
	}
...
//		$table = Table::getInstance('TonkhoTable', __NAMESPACE__ . '\\', array('dbo' => $this->_db));
//
