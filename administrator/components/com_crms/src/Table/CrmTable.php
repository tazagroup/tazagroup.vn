 ...
 * @since  1.6
 */
class CrmTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_crms.crm';
		parent::__construct('#__crms', 'id', $db);
	...
	public function store($updateNulls = true)
	{
		...
		$table = Table::getInstance('CrmTable', __NAMESPACE__ . '\\', array('dbo' => $this->_db));
