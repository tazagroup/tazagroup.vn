 ...
 * @since  1.6
 */
class ChuyenkhoctTable extends Table implements VersionableTableInterface, TaggableTableInterface
{
	...
	{
		$this->typeAlias = 'com_crms.chuyenkhocts';
		parent::__construct('#__crms_chuyenkho_chitiet', 'id', $db);
	}
