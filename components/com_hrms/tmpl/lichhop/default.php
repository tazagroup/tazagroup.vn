...
HTMLHelper::_( 'script', 'components/com_hrms/js/maincalendar.min.js', array( 'version' => 'auto' ), array( 'defer' => 'true' ) );
HTMLHelper::_( 'script', 'components/com_hrms/js/locales-all.min.js', array( 'version' => 'auto' ), array( 'defer' => 'true' ) );
HTMLHelper::_( 'stylesheet', 'administrator/components/com_hrms/css/maincalendar.min.css', array( 'version' => 'auto' ), array( 'defer' => 'true' ) );
...
<div ng-app="Site" ng-controller="Site" ng-init="ReadHoso(<?php echo $User->get('id'); ?>)"> 
  <div class="col-12 d-flex align-items-center justify-content-center">
    <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-999">
      <div id='calendar'></div>
    </div>
  </div>
</div>    
