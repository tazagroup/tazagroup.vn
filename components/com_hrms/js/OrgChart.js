...
OrgChart.prototype.load = function(t) {
    ...
    this.server.read(t, this.width(), this.height(), e, C, y, function(t) {
        C != OrgChart.action.exporting && (x.nodes = t.nodes, x.visibleNodeIds = t.visibleNodeIds, x.roots = t.roots), x.editUI.fields = t.allFields;
        var e = {
            defs: ""
        };
        ...
        for (o = 0; o < t.visibleNodeIds.length; o++) {
            ...
            r += x.ui.link(l, x, i, t.bordersByRootIdAndLevel, t.nodes, C), r += x.ui.expandCollapseBtn(x, l, x._layoutConfigs, C, i)
        }
        e = {
            content: r,
            res: t
        ...
        if (OrgChart.events.publish("render", [x, e]), r = e.content, r += x.ui.lonely(x.config), C !== OrgChart.action.exporting) {
            C !== OrgChart.action.centerNode && C !== OrgChart.action.insert && C !== OrgChart.action.expand && C !== OrgChart.action.collapse && C !== OrgChart.action.update || (n = a), C === OrgChart.action.init && null != a && (n = a), x.response = t;
            ...
            if (0 < g[0].length) {
                ...
                OrgChart.anim(g[0], g[1], g[2], x.config.anim.duration, x.config.anim.func, function() {
                    c || (O && O(), OrgChart.events.publish("redraw", [x]), x._showAfterAnimation(), c = !0)
                })
            }
            C === OrgChart.action.centerNode ? OrgChart.anim(x.getSvg(), {
                viewbox: a
            }, {
                viewbox: x.response.viewBox
            }, x.config.anim.duration, x.config.anim.func, function() {
                x.ripple(y.options.rippleId), c || (O && O(), OrgChart.events.publish("redraw", [x]), x._showAfterAnimation(), c = !0)
            }, function() {
                x.xScrollUI.setPosition(), x.yScrollUI.setPosition()
            }) : !a || !x.response || a[0] == x.response.viewBox[0] && a[1] == x.response.viewBox[1] && a[2] == x.response.viewBox[2] && a[3] == x.response.viewBox[3] || C !== OrgChart.action.insert && C !== OrgChart.action.expand && C !== OrgChart.action.collapse && C !== OrgChart.action.update && C !== OrgChart.action.init ? 0 == g[0].length && (c || (O && O(), OrgChart.events.publish("redraw", [x]), c = !0)) : OrgChart.anim(x.getSvg(), {
                viewbox: a
            }, {
                viewbox: x.response.viewBox
            }, 500, OrgChart.anim.inOutPow, function() {
                x.xScrollUI.setPosition(), x.yScrollUI.setPosition(), c || (O && O(), OrgChart.events.publish("redraw", [x]), c = !0)
        ...
        for (var t = 0; t < c.length; t++)
            for (var e in p[t]) {
                ...
                switch (e.toLowerCase()) {
                    ...
                    case "transform":
                        if (p[t][e]) {
                            for (var h in o = g[t][e], l = p[t][e], s = [0, 0, 0, 0, 0, 0], o) s[h] = u((10 * O - 10) / f) * (l[h] - o[h]) + o[h];
                    ...
                    case "margin":
                        ...
                        break;
                    case "scrolly":
                        n = u((10 * O - 10) / f) * (p[t][e] - g[t][e]) + g[t][e], c[t].scrollTo(0, n);
                        break;
                    default:
                        n = u((10 * O - 10) / f) * (p[t][e] - g[t][e]) + g[t][e], c[t] && c[t].style && (c[t].style[e] = n + r)
                }
            }
        C && C(), 1 + x < (O += 1) && (clearInterval(y), m && m(c))
    }, 10)
    ...
    if (-1 == a.indexOf("id") || -1 == a.indexOf("pid")) {
        ...
        for (var f = 0; f < a.length; f++) {
            (O = document.createElement("option")).setAttribute("value", a[f]);
        ...
        for (f = 0; f < a.length; f++) {
            ...
            O.appendChild(u), y.appendChild(O)
        }
            ...
            a = function(t) {
                if (_) {
                    ...
                    if (a.left || a.right || a.up || a.down) {
                        ...
                        if (b.stopMove(), w.classList && (w.classList.add("cursor-grab"), w.classList.remove("cursor-move"), w.classList.remove("cursor-nodrop"), w.classList.remove("cursor-copy")), N(x, v), v = x = null, b.config.enableDragDrop)
                            for (; null != r && r != w;) {
                        ...
                        if (null != x) {
                            ...
                            for (var g = b.getNode(x), p = OrgChart.getStParentNodes(g), f = 0; f < p.length; f++) {
                                ...
                                u && (u.style.opacity = .1)
                            }!b._canUpdateLink(O.id, x) && w.classList ? (w.classList.remove("cursor-grab"), w.classList.remove("cursor-move"), w.classList.remove("cursor-copy"), w.classList.add("cursor-nodrop")) : w.classList && (w.classList.remove("cursor-grab"), w.classList.remove("cursor-move"), w.classList.add("cursor-copy"), w.classList.remove("cursor-nodrop"))
                        }
                        var m = (e.x - _.x) / A,
                            C = (e.y - _.y) / A;
                        if (k[4] = S + m, k[5] = I + C, !y._dragEventFired && (Math.abs(e.x - _.x) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE || Math.abs(e.y - _.y) > OrgChart.FIRE_DRAG_NOT_CLICK_IF_MOVE)) !1 === OrgChart.events.publish("drag", [b, c]) && L(), y._dragEventFired = !0;
                        E.setAttribute("transform", "matrix(" + k.toString() + ")")
                    }
                }
            },
            L = function(t) {
                if (b.stopMove(), w.classList && (w.classList.remove("cursor-grab"), w.classList.remove("cursor-move"), w.classList.remove("cursor-nodrop"), w.classList.remove("cursor-copy")), w.removeEventListener(i.move, a), w.removeEventListener(i.up, L), i.leave && w.removeEventListener(i.leave, L), O.id != x && null != x) {
                    var e = b.getNode(x);
                    if (!1 === OrgChart.events.publish("drop", [b, O.id, e.id])) return N(x, v), w.removeChild(E), void(b._gragStartedId = null);
                    if (b._canUpdateLink(O.id, x)) {
                        var r = b.get(O.id);
                        r.pid = x, r.stpid = null, b.updateNode(r, null, !0)
                    } else w.removeChild(E), N(x, v);
                    b._gragStartedId = null
                } else {
                    w.removeChild(E), b._gragStartedId = null;
                    OrgChart._getClientXY(t);
                    y._dragEventFired && OrgChart.events.publish("drop", [b, O.id])
                }
            };
        w.addEventListener(i.move, a), w.addEventListener(i.up, L), i.leave && w.addEventListener(i.leave, L)
    }
    ...
    if (this.searchUI.hide(), this.nodeMenuUI.hide(), this.nodeContextMenuUI.hide(), this.menuUI.hide(), r == OrgChart.action.expandCollapse && this.toggleExpandCollapse(t, e), r == OrgChart.action.edit) {
        var i = this.getNode(t);
...
OrgChart.prototype._mouseDownHandler = function(t, e, r) {
    ...
    if (OrgChart.server._initNode(e, r, s, i, c, h, d, g, p, f, u), e.isAssistant && (n[e.pid] || (n[e.pid] = []), n[e.pid].push(e.id)), 0 < e.subLevels && o.push(e.id), !e.isAssistant && 0 == e.childrenIds.length && e.parent && !l[e.pid]) {
        for (var m = [], C = 0, y = 0, O = 0; O < e.parent.children.length; O++) {
            var x = e.parent.children[O]; - 1 == x.tags.indexOf("partner") && -1 == x.tags.indexOf("assistant") && 0 == x.childrenIds.length ? m.push(x.id) : -1 != x.tags.indexOf("assistant") ? C++ : -1 != x.tags.indexOf("partner") && y++
        }
    ...
    if (null != a.roots) {
        ...
        for (d = 0; d < a.roots.length; d++) {
            var x = l[a.roots[d]];
            if (x && e == OrgChart.action.centerNode) {
                for (var v = x; null != v.pid || null != v.stpid;) v = null == v.pid && null != v.stpid ? l[v.stpid] : l[v.pid];
            ...
            if (x) {
                for (var w = !1, _ = 0; _ < h.length; _++)
                    ...
                    if (!OrgChart.isNullOrEmpty(x.pid)) - 1 < (X = (y = l[x.pid]).childrenIds.indexOf(x.id)) && y.childrenIds.splice(X, 1), x.pid = null;
                    h.push(x)
                }
            }
        }
    ...
    if (e == OrgChart.action.init && a.expand && a.expand.nodes && null == n)
        ...
        for (f = l[r.insertedNodeId]; f;) k.push(f.id), null == f.pid && null != f.stpid ? (f = l[f.stpid]).min = !1 : f = l[f.pid];
    var E = [],
        N = {},
        L = [],
        M = {},
        T = [];
    for (d = 0; d < h.length; d++) OrgChart.server._iterate(h[d], h[d], l, 0, E, N, L, M, "", t, a, e, k, r, T, n);
    ...
    for (d = 0; d < T.length; d++) {
        ...
        for (I = 0; I < f.children.length; I++) {
            (Y = f.children[I]).isAssistant || (-1 != Y.tags.indexOf("right-partner") ? (Y.isPartner = 1, Y.children = [], P.push(Y.id)) : -1 != Y.tags.indexOf("left-partner") ? (Y.isPartner = 2, Y.children = [], F.push(Y.id)) : -1 == Y.tags.indexOf("partner") || H % 2 ? -1 != Y.tags.indexOf("partner") && H % 2 ? (Y.isPartner = 2, Y.children = [], F.push(Y.id), H++) : null != Y.ppid ? (z[Y.ppid] || (z[Y.ppid] = []), z[Y.ppid].push(Y.id)) : B.push(Y.id) : (Y.isPartner = 1, Y.children = [], P.push(Y.id), H++))
        }
        f.children = [];
        ...
        for (I = F.length - 1; 0 <= I; I--)
            if (z[F[I]])
                for (_ = 0; _ < z[F[I]].length; _++) f.children.push(l[z[F[I]][_]]), R++, -1 == D.indexOf(F[I]) && D.push(F[I]);
        ...
        for (I = 0; I < P.length; I++)
            if (z[P[I]])
                for (_ = 0; _ < z[P[I]].length; _++) f.children.push(l[z[P[I]][_]]), j++, -1 == U.indexOf(P[I]) && U.push(P[I]);
        f.partnerSeparation = Math.max(D.length, U.length) * a.partnerChildrenSplitSeparation + a.minPartnerSeparation, B.length || !R || j ? B.length || R || !j ? B.length || 1 != R || 1 != j ? B.length || R || j ? !B.length || R || j ? B.length && (R || j) ? f.hasPartners = 7 : f.hasPartners = 1 : f.hasPartners = 6 : f.hasPartners = 5 : f.hasPartners = 4 : f.hasPartners = 3 : f.hasPartners = 2
    }
    for (d = 0; d < L.length; d++) {
        if ((at = t[(f = l[L[d]]).lcn ? f.lcn : "base"]).layout == OrgChart.normal || !M[f.pid])
            for (I = 0; I < f.subLevels; I++) {
                var X, q = new OrgChart.node(f.id + "_sub_level_index_" + I, f.pid, [], "subLevel");
                if (OrgChart.server._initDinamicNode(q, f.lcn), y = f.parent) - 1 < (X = y.children.indexOf(f)) && (y.children.splice(X, 1), y.children.splice(X, 0, q)), q.children.push(f), q.parent = y, f.parent = q, l[q.id] = q
            }
    }
    for (var V in N) {
            ...
            if ((at = t[(y = l[V]).lcn ? y.lcn : "base"]).layout == OrgChart.mixed || at.layout == OrgChart.tree || at.layout == OrgChart.treeRightOffset || at.layout == OrgChart.treeLeftOffset) {
                ...
                if (OrgChart.events.publish("layout", [nt]), nt.layout == OrgChart.mixed) {
                    ...
                    for (I = 0; I < st.length; I += 3) {
                        ...
                        0 != I && (Q = l[st[I - 3]]), 0 == I || tt || (Q = l[st[I - 2]]), ($.parent = Q).children.push($), tt && (0 != I && (Q = l[st[I - 2]]), (tt.parent = Q).children.push(tt)), et && (0 != I && (Q = l[st[I - 1]]), (et.parent = Q).children.push(et))
                    }
                }
            }
        }
    ...
    var u = h[0],
        ...
        O = a - o + 2 * i.padding,
        x = n - l + 2 * i.padding,
        v = OrgChart.getScale(s, t, e, i.scaleInitial, i.scaleMax, i.scaleMin, O, x);
    ...
    node: function(t, e, r, i, a, n, o, l, s, h) {
        ...
        for (var p in o) {
            ...
            if (e) {
                ...
                if ("function" == typeof f && (u = f(h, t, e)), g.value = u, g.element = d[p], g.name = f, !1 !== OrgChart.events.publish("field", [h, g]))
                    if (null != g.value && null != g.value && null != g.element) c += (OrgChart._lblIsImg(i, p) || "string" != typeof g.value || (g.value = OrgChart.wrapText(g.value, g.element)), g.element.replace("{val}", function() {
                        return g.value
        ...
        var y = "";
        t.lcn && (y = 'lcn="' + t.lcn + '"');
        var O = OrgChart.nodeOpenTag.replace("{lcn}", y).replace("{id}", t.id).replace("{class}", C).replace("{sl}", t.sl).replace("{level}", t.level).replace("{x}", m.x).replace("{y}", m.y),
    ...
    link: function(t, e, r, i, a, n) {
        ...
        if (t.hasPartners) {
            ...
            for (var u = 0; u < t.children.length; u++) {
                var m = null;
                null != (C = t.children[u]).ppid && (m = a[C.ppid]), m ? (f.ppnodes[C.id] = m, f.ids.push(C.id), 1 == m.isPartner ? (-1 == f.rightIds.indexOf(m.id) && f.rightIds.push(m.id), f.indexes[C.id] = f.rightIds.indexOf(m.id), f.firstRight || (f.firstRight = C)) : 2 == m.isPartner && (-1 == f.leftIds.indexOf(m.id) && f.leftIds.push(m.id), f.indexes[C.id] = f.leftIds.indexOf(m.id), f.lastLeft = C)) : C.isPartner || (f.lastLeft = C, f.firstRight || (f.firstRight = C))
            }
        ...
        for (u = 0; u < t.children.length; u++) {
            var C = t.children[u],
                ...
                x = (s = OrgChart.t(C.templateName, C.min, r)).link;
            if (f && -1 != f.ids.indexOf(C.id)) switch (l.orientation) {
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                    O = OrgChart.ui._linkPpTop(f, t, C, y, p, s);
                    break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                    O = OrgChart.ui._linkPpBottom(f, t, C, y, p, s);
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                    O = OrgChart.ui._linkPpRight(f, t, C, y, p, s);
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                    O = OrgChart.ui._linkPpLeft(f, t, C, y, p, s)
                ...
                case OrgChart.orientation.top:
                case OrgChart.orientation.top_left:
                    if (1 == C.isPartner) O = OrgChart.ui._linkLeftToRight(t, C, s, c);
                    else if (2 == C.isPartner) O = OrgChart.ui._linkRightToLeft(t, C, s, c);
                    else {
                        var v = 1 == C.layout ? void 0 : y.minY - (y.minY - p.maxY) / 2;
                        O = OrgChart.ui._linkTopToBottom(t, C, s, d, v)
                    }
                    break;
                case OrgChart.orientation.bottom:
                case OrgChart.orientation.bottom_left:
                    if (1 == C.isPartner) O = OrgChart.ui._linkLeftToRight(t, C, s, c);
                        ...
                        v = 1 == C.layout ? void 0 : y.maxY - (y.maxY - p.minY) / 2;
                        O = OrgChart.ui._linkBottomToTop(t, C, s, d, v)
                    }
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                    if (1 == C.isPartner) O = OrgChart.ui._linkTopToBottom(t, C, s, c);
                    else if (2 == C.isPartner) O = OrgChart.ui._linkBottomToTop(t, C, s, c);
                    else {
                        v = 1 == C.layout ? void 0 : y.maxX - (y.maxX - p.minX) / 2;
                        O = OrgChart.ui._linkRightToLeft(t, C, s, d, v)
                    }
                    break;
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                    if (1 == C.isPartner) O = OrgChart.ui._linkTopToBottom(t, C, s, c);
                        ...
                        v = 1 == C.layout ? void 0 : y.minX - (y.minX - p.maxX) / 2;
                        O = OrgChart.ui._linkLeftToRight(t, C, s, d, v)
                    }
            }
            if (-1 != x.indexOf("{rounded}"))
                if (O.xa == O.xb && O.xa == O.xc && O.xa == O.xd || O.ya == O.yb && O.ya == O.yc && O.ya == O.yd) x = x.replace("{rounded}", "M" + O.xa + "," + O.ya + " L" + O.xd + "," + O.yd);
                    ...
                    var b = OrgChart.ui._roundedEdge(O.xa, O.ya, O.xb, O.yb, O.xc, O.yc),
                        w = OrgChart.ui._roundedEdge(O.xb, O.yb, O.xc, O.yc, O.xd, O.yd);
                    x = x.replace("{rounded}", "M" + b.x1 + "," + b.y1 + " " + b.x2 + "," + b.y2 + " Q" + b.qx1 + "," + b.qy1 + " " + b.qx2 + "," + b.qy2 + " L" + w.x2 + "," + w.y2 + " Q" + w.qx1 + "," + w.qy1 + " " + w.qx2 + "," + w.qy2 + " L" + w.x3 + "," + w.y3)
                }
            ...
            var k = "";
            for (var S in e.config.linkBinding) {
                var I = e.config.linkBinding[S],
                    A = e._get(C.id);
                if (A) {
                    var E = A[I];
                    _.value = E, _.element = s[S], _.name = I, !1 !== OrgChart.events.publish("label", [e, _]) && (OrgChart.isNullOrEmpty(_.value) || OrgChart.isNullOrEmpty(_.element) || (k += _.element.replace("{val}", _.value)))
                }
            }
            "" != k && (k = OrgChart.linkFieldsOpenTag.replace("{x}", O.x).replace("{y}", O.y).replace("{rotate}", 0) + k + OrgChart.grCloseTag, h.push(k)), h.push(OrgChart.grCloseTag)
        }
        return h.join("")
    },
    ...
    if ("multiline" == s) {
        ...
        for (var y = 1, O = 1; O < f.length; O++) {
            ...
            if (m.firstChild.data += " " + f[O], m.getComputedTextLength() > l) {
                if (m.firstChild.data = m.firstChild.data.slice(0, x), y++, 0 !== c && c < y) break;
    ...
    for (var r, i, a, n, o, l = "", s = 0; s < this.config.clinks.length; s++) {
        ...
        if (-1 != e.res.visibleNodeIds.indexOf(h.from) && -1 != e.res.visibleNodeIds.indexOf(h.to)) {
            ...
            switch (this.config.orientation) {
                ...
                case OrgChart.orientation.left:
                case OrgChart.orientation.left_top:
                    m.y = x <= v ? (b = -1, x + d.h / 5) : (b = 1, x - d.h / 5), C.y = v + c.h / 5, g == f ? (b = -1, m.x = g, C.x = f) : f < g ? (m.x = g, C.x = f + c.w) : (m.x = g + d.w, C.x = f);
                    break;
                case OrgChart.orientation.right:
                case OrgChart.orientation.right_top:
                    m.y = x <= v ? (b = 1, x + d.h / 5) : (b = -1, x - d.h / 5), C.y = v + c.h / 5, g == f ? (b = 1, m.x = g + d.w, C.x = f + c.w) : f < g ? (m.x = g, C.x = f + c.w) : (m.x = g + d.w, C.x = f)
            }
            var w = I(m, C, b),
                _ = h.template;
            _ || (_ = "orange");
    ...
    function e(t, e, r) {
        ...
        var b = i.join(" ");
        if (I += '<g c-link-from="{from}" c-link-to="{to}">'.replace("{from}", t.id).replace("{to}", e.id) + s.link.replaceAll("{d}", b), N.label) {
            var w = s.label.replace("{x}", O.x).replace("{y}", O.y).replace("{val}", N.label),
            ...
            I += s.label.replace("{x}", O.x).replace("{y}", O.y + k).replace("{val}", N.label)
        }
        I += OrgChart.grCloseTag
    }
    for (var r = 0; r < this.config.slinks.length; r++) {
        var N = this.config.slinks[r];
        if (-1 != t.res.visibleNodeIds.indexOf(N.from) && -1 != t.res.visibleNodeIds.indexOf(N.to)) {
            var i = S.getNode(N.from),
                a = S.getNode(N.to);
    ...
    t.config.enableKeyNavigation && (t._keyNavigationActiveNodeId = e.node.id, t.center(e.node.id))
}), OrgChart._keyNavigation = function(t) {
    var e = t.element.querySelector(":focus");
    if (e && e.parentElement && e.parentElement.hasAttribute("node-id")) {
