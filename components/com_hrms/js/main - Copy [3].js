...
var app = angular.module('Site', ['ui.filters', 'localytics.directives', 'ngSanitize', 'ui.tinymce']);
...
app.controller('Site', function ($scope, $http, $filter, $sce,$timeout) {
...
//    $scope.SNT={'from':'','to':''};
  ...
  $scope.Oninitlichhop = function (initialDate,iduser) {
    $scope.idChutri = iduser.toString();
   var iDate =   (initialDate != "")? $filter('date')(new Date(initialDate), "yyyy-MM-dd") : $filter('date')(new Date(), "yyyy-MM-dd");
    ...
    $scope.Lichhop = {
      'Title': 'Tạo mới',
      'idChutri':$scope.idChutri,
      'CRUD': 0
    };
      
    $('.modal').modal('hide');
    $scope.isdisabled = false;
  //  console.log(iDate,iduser,$scope.Lichhop.idChutri);   
  }
  $scope.CreateLichhop = function (dulieu) {
    ...
    $http.post("https://tazagroup.vn/api/index.php/v1/hrms/lichhops", data, {
      ...
      .then(function (res) {
        ...
        $scope.Oninitlichhop(data.NgayBD,$scope.idChutri);
      }, function (res) {
        Thongbao(1, geterror(res));
       // console.log(res);
      });
    ...
    $http.patch("https://tazagroup.vn/api/index.php/v1/hrms/lichhops/" + dulieu.id, data, {
      ...
      .then(function (res) {
       // console.log(res);
        ...
        data.idThamgia = JSON.parse(data.idThamgia);
        $scope.UpdateDauviec1(data);
      //  $scope.Oninitlichhop(data.NgayBD,$scope.idChutri);
      }, function (res) {
       // console.log(res);
      });
  ...
  $scope.DropLichhop = function (data) {
    ...
    $http.patch("https://tazagroup.vn/api/index.php/v1/hrms/lichhops/" + dulieu.id, dulieu, {
      ...
      .then(function (res) {
        ...
        $scope.Oninitlichhop(dulieu.NgayBD,$scope.idChutri);
      }, function (res) {
        console.log(res);
      });
  }
...
//  console.log(arg);
 ...
 events: events,
  ...
  $scope.EventClick = function (data) {
    ...
    $scope.Lichhop.NgayBD = $scope.Lichhop.NgayBD;
    $scope.Lichhop.NgayKT =$scope.Lichhop.NgayKT;
    $scope.Lichhop.Trienkhai = $scope.Lichhop.Trienkhai;
    $scope.Lichhop.Review = $scope.Lichhop.Review;
    $scope.Lichhop.Hoanthanh = $scope.Lichhop.Hoanthanh;
...
$scope.editDauviec = function (data) {
 ...
 $scope.UpdateDauviec = function (data) {
    ...
    $http.patch("https://tazagroup.vn/api/index.php/v1/hrms/gtodos/"+data.id,dulieu, {
      ...
      .then(function (res) {
        console.log(res);
        Thongbao(0,"Cập nhật dữ liệu thành công");
//          $timeout(function() {
//                location.reload();
//        },1000)
        $scope.Oninitdauviec('','');
 ...
 $scope.ReadGviec = function () {
    $http.get("https://tazagroup.vn/api/index.php/v1/hrms/gtodos?filter[published]=0&page[offset]=0&page[limit]=*", {
        headers: $scope.headers
      })
      .then(function (res) {
       $scope.RNhomviec = [];
